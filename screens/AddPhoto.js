  ...
  render () {
    ...
    return (
      <View stickyHeaderIndices = {[0]} style={{ backgroundColor: '#323643', flex: 1 }}>
        ...
        <View style = {{flex : 2, backgroundColor : '#fff' , marginHorizontal : 12, borderRadius : 5 , marginVertical : 5} }>
            </View>
            <View style = {{flex : 1,  marginHorizontal : 12,}}>
                ...
                justifyContent : 'space-around'}}>
                    <Image style = {{height : 50 , width : 50 , borderRadius : 5 , backgroundColor : '#fff'}} />
                    <View style = {{height :  70 , width : 70 , borderRadius : 125 , borderColor : pinkColor , 
                        borderWidth : 1 , justifyContent : "center" , alignItems : "center"}}> 
                    <TouchableOpacity style = {{height : 60 , width : 60 , borderRadius : 125 , 
